...
class FruitRepository {
    ...
    fun getAllFruits() = allFruits

    private fun initAllBooks() {
        var title = ""
        var headline = ""
        var image = ""
        var description = ""
        var gradientColors = ArrayList<String?>()
        var nutrition = ArrayList<String?>()
        id++
        title = "Blueberry"
        headline = "Blueberries are sweet, nutritious and wildly popular fruit all over the world."
        image = "blueberry"
        description =
            """Blueberries are perennial flowering plants with blue or purple berries. They are classified in the section Cyanococcus within the genus Vaccinium. Vaccinium also includes cranberries, bilberries, huckleberries and Madeira blueberries./nCommercial blueberries—both wild (lowbush) and cultivated (highbush)—are all native to North America. The highbush varieties were introduced into Europe during the 1930s.
...
"""
        ...
        image = "lime"
        description =
            """ lime (from French lime, from Arabic līma, from Persian līmū, "lemon")[1] is a citrus fruit, which is typically round, green in color, 3–6 centimetres (1.2–2.4 in) in diameter, and contains acidic juice vesicles.
